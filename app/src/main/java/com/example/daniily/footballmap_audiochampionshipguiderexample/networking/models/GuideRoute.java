...
public class GuideRoute {
    ...
    static {
        ...
        points.add(new Place(locate, new LatLng(54.706383, 20.512047), "kafsobor.mp3"));

        locate = new Place.PlaceLocate(Constants.Localization.RUS, "Художественная галерея", "");
        points.add(new Place(locate, new LatLng(54.708498, 20.5199), "muzeyiskusstv.mp3"));

        locate = new Place.PlaceLocate(Constants.Localization.RUS, "Закхаймские ворота", "");
        points.add(new Place(locate, new LatLng(54.709593, 20.538291), "zakhay.mp3"));

        locate = new Place.PlaceLocate(Constants.Localization.RUS, "Королевские ворота", "");
        points.add(new Place(locate, new LatLng(54.713761, 20.535796), "korolevskiyevorota.mp3"));

        locate = new Place.PlaceLocate(Constants.Localization.RUS, "Казарма Кронпринц", "");
        points.add(new Place(locate, new LatLng(54.717001, 20.531291), "kronprinz.mp3"));

        locate = new Place.PlaceLocate(Constants.Localization.RUS, "Памятник Василевскому", "");
        points.add(new Place(locate, new LatLng(54.720838, 20.523863), "pamyatnikvasilevskomu.mp3"));

        locate = new Place.PlaceLocate(Constants.Localization.RUS, "Россгартенские ворота", "");
        points.add(new Place(locate, new LatLng(54.722051, 20.523815), "rosgart.mp3"));
